...
kpi_vs_budget_data_ext = {
    ...
    "This Week": ["3,406,791", "152,562", "22.93", "32.18%"],
    "Budget": ["3,178,203", "423,065", "21.69", "29.60%"],
    "L4wt": ["3,210,000", "148,000", "22.75", "30.5%"],
    "Bdg": ["3,000,000", "155,000", "23.10", "31.01%"],
    "Tw/Bdg (+/-)": ["-61.50", "-63.90", "+3.70", "+3.00%"],
    "Percent Change": ["8.80%", "89.43%", "5.78%", "6.00%"]
}

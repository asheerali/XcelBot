...
async def upload_excel(request: ExcelUploadRequest = Body(...)):
    ...
    try:
        ...
        if request.dashboard == ["Sales Split", "Product Mix"]:
            ...
            net_sales, orders, qty_sold, sales_by_category_df, sales_by_menu_group_df, sales_by_server_df, top_selling_items_df, sales_by_location_df, average_price_by_item_df, average_order_value, average_items_per_order, price_changes_df, top_items_df, unique_orders, total_quantity = process_pmix_file

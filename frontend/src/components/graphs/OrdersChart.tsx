...
const OrdersChart: React.FC<OrdersChartProps> = ({ data = [], height = 400 }) => {
  ...
  const transformDataForChart = () => {
    ...
    const chartData = data
      ...
      .map(item => {
        ...
        const twLwChange = parseFloat(item['Tw/Lw (+/-)'] || item.twLwChange || 0);
        const twLyChange = parseFloat(item['Tw/Ly (+/-)'] || item.twLyChange || 0);

...
const SalesChart: React.FC<SalesChartProps> = ({ data }) => {
  ...
  const transformDataForChart = () => {
    ...
    return data
      ...
      .map((row) => {
        const dayOfWeek =
          row["Day of the Week"] || row["Day of The Week"] || "";
        ...
        return {
          ...
          displayTwLwChange: `${twLwChange >= 0 ? "+" : ""}${twLwChange.toFixed(
            2
          )}%`,
          displayTwLyChange: `${twLyChange >= 0 ? "+" : ""}${twLyChange.toFixed(
            2
          )}%`,
        };
      });
      ...
      <Box sx={{ width: "100%", height: 400 }}>
        <ResponsiveContainer>
          ...
          >
            ...
            <XAxis dataKey="day" fontSize={12} tick={{ fill: "#666" }} />
            <YAxis
              fontSize={12}
              tick={{ fill: "#666" }}
              label={{

...
const DeliveryPercentageChart: React.FC<DeliveryPercentageChartProps> = ({
  tableData,
}) => {
      ...
      return (
        ...
        >
          ...
          {filteredPayload.map((entry: any, index: number) => (
            ...
            >
              ...
              {entry.payload[`${entry.name}_raw`] !== undefined &&
                ` ($${entry.payload[`${entry.name}_raw`].toLocaleString(
                  undefined,
                  {
          ...
          {filteredPayload[0]?.payload["In-House_raw"] !== undefined && (
            ...
            >
              In-House: $
              {filteredPayload[0].payload["In-House_raw"].toLocaleString(
                undefined,
                {
                  minimumFractionDigits: 2,
                  maximumFractionDigits: 2,
      ...
      <Card sx={{ mb: 4 }}>
        <CardContent>
          ...
          <Typography color="text.secondary">
            No data available. Please upload an Excel file with valid delivery
            data.
          </Typography>
        </CardContent>
      </Card>

...
export function ExcelImport() {
  ...
  const initialTableData = {
    ...
    fileLocation: "", // File location on the server
    // [key: string]: any
  };
    ...
    return (
      ...
      >
        {!veryCompact && (
          ...
          >
            <Typography variant={veryCompact ? "subtitle1" : "h6"}>
              {tableLabels[tableIndex]}
            </Typography>
    ...
    >
      ...
      >
        ...
        <Typography variant="body2">
          • <strong>Percentage Table</strong>: Shows week-over-week changes
          <br />• <strong>In-House Table</strong>: Categories as % of In-House
          sales
          <br />• <strong>WOW Table</strong>: Includes 3P totals and 1P/3P ratio
          <br />• <strong>Category Summary</strong>: Overall sales by category
          <br />
          <br />

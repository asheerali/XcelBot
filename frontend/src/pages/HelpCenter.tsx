...
export function HelpCenter() {
  ...
  const helpOptions = [
    {
      ...
      description:
        "Find instant answers to common questions about our platform, features, and best practices.",
      path: "/Faq",
      color: "#1976d2",
      delay: "0ms",
    },
    {
      ...
      description:
        "Get expert help from our support team for technical issues and troubleshooting.",
      path: "/ContactUs",
      color: "#9c27b0",
      delay: "100ms",
    },
    {
      ...
      title: "Meet Our Team",
      description:
        "Connect with our team members for partnerships, business inquiries, and collaboration.",
      path: "/ContactTeam",
      color: "#ed6c02",
      delay: "200ms",
    },
  ...
  return (
    ...
    >
      ...
      <FloatingElement
        sx={{ top: "60%", right: "15%", animationDelay: "2s" }}
      />
      <FloatingElement
        sx={{ bottom: "30%", left: "20%", animationDelay: "4s" }}
      />
      ...
      <HeroSection>
        <Container maxWidth="md">
          <Box sx={{ textAlign: "center", position: "relative", zIndex: 1 }}>
            ...
            >
              Welcome to our comprehensive Help Center. We're here to support

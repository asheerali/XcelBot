...
//         {renderHeader("Total Sales", "total_sales")}
//         {renderHeader(
...
//           {/* Location chips - show first few, then expand button */}
...
//               <LocationChip
//                 label={`+${fileLocations.length - 2} more`}
//                 size="small"
//                 variant="outlined"
//                 color="default"
//                 onClick={() => toggleFileExpansion(file.file_name)}
...
//                                                 </Box>
//                                                 <Typography variant="body2" color="text.secondary">
//                                                   Records: {location.record_count?.toLocaleString() || "N/A"}
//                                                 </Typography>
//                                                 <Typography variant="body2" color="text.secondary">
//                                                   Sales: {formatCurrency(location.total_sales)}
//                                                 </Typography>
//                                                 {currentDataType.key === "salespmix" ? (
//                                                   <Typography variant="body2" color="text.secondary">
//                                                     Period: {formatDate(location.earliest_date)} - {formatDate(location.latest_date)}
//                                                   </Typography>
//                                                 ) : (
//                                                   <Typography variant="body2" color="text.secondary">
//                                                     Years: {location.earliest_year} - {location.latest_year}
//                                                   </Typography>
//                                                 )}
//                                               </StyledCard>
//                                             </Grid>
...
//                     </Typography>
//                     <Typography variant="body2" color="text.secondary">
//                       {locations.length} {currentDataType.key === "salespmix" ? "locations" : "stores"} available
//                     </Typography>
//                   </Box>
//                 </Box>
//               </Box>
...
//                       gutterBottom
//                     >
//                       No {currentDataType.key === "salespmix" ? "locations" : "stores"} found
//                     </Typography>
//                     <Typography variant="body2" color="text.disabled">

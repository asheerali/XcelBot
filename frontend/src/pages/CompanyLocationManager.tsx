...
const CompanyLocationManager: React.FC = () => {
  ...
  const handleDeleteCompany = (companyId: string) => {
    ...
    if (
      company &&
      window.confirm(
        `Are you sure you want to delete "${company.name}"? This will also delete all its locations and users.`
      )
    ) {
  ...
  const handleSaveCompany = () => {
    if (
      ...
      showNotification(
        "Name, city, state, post code, and phone are required",
        "error"
      );
      return;
    }
          ...
          company.id === companyId
            ? {
                ...
                users: company.users.map((user) => ({
                  ...user,
                  assignedLocations: user.assignedLocations.filter(
  ...
  const handleSaveLocation = () => {
    if (
      ...
      showNotification(
        "Name, city, state, and post code are required",
        "error"
      );
      return;
    }
          ...
          company.id === companyId
            ? {
                ...
                locations: company.locations.map((location) => ({
                  ...location,
                  manager:
                    location.manager === userId ? undefined : location.manager,
                })),
                updatedAt: new Date(),
              }
            : company
          ...
          >
            ...
            >
              ...
              <Typography variant="caption" sx={{ opacity: 0.8 }}>
                ...
                {stats.totalLocations - stats.activeLocations} Inactive
              </Typography>
            </CardContent>
          </Card>
        </Grid>
                    ...
                    <React.Fragment key={company.id}>
                      ...
                      <TableRow
                        sx={{
                          ...
                          borderLeft: `4px solid ${
                            company.isActive ? "#4caf50" : "#f44336"
                          }`,
                      ...
                      >
                        <TableCell>
                          <IconButton
                            ...
                            sx={{
                              ...
                              transform: expandedCompanies.has(company.id)
                                ? "rotate(180deg)"
                                : "rotate(0deg)",
                            }}
                          >
                        ...
                        <TableCell>
                          ...
                          >
                            <Badge
                              badgeContent={
                                company.locations.filter((l) => l.isActive)
                                  .length
                              }
                              color="primary"
                            >
                              <Chip
                                label={`${company.locations.length} location${
                        ...
                        <TableCell>
                          ...
                          >
                            <Badge
                              badgeContent={
                                company.users.filter((u) => u.isActive).length
                              }
                              color="secondary"
                            >
                              <Chip
                                label={`${company.users.length} user${
                      ...
                      <TableRow>
                        <TableCell colSpan={6} sx={{ p: 0, border: "none" }}>
                          <Collapse
                            in={expandedCompanies.has(company.id)}
                            timeout="auto"
                            unmountOnExit
                          >
                            <Box
                                    ...
                                    <Table size="small">
                                      ...
                                      <TableBody>
                                        {company.locations.map((location) => {
                                          ...
                                          const managerName = location.manager
                                            ? getUserName(
                                                company.id,
                                                location.manager
                                              )
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={
                    !companyForm.name.trim() ? "Company name is required" : ""
                  }
                  sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2 } }}
                />
              </Grid>
              ...
              <Grid item xs={12} md={6}>
                <TextField
                  ...
                  helperText={
                    !companyForm.city.trim() ? "City is required" : ""
                  }
                  sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2 } }}
                />
              </Grid>
              ...
              <Grid item xs={12} md={3}>
                <TextField
                  ...
                  helperText={
                    !companyForm.state.trim() ? "State is required" : ""
                  }
              ...
              <Grid item xs={12} md={3}>
                <TextField
                  ...
                  helperText={
                    !companyForm.postCode.trim() ? "Post code is required" : ""
                  }
                  placeholder="12345"
                  sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2 } }}
                />
              ...
              <Grid item xs={12} md={6}>
                <TextField
                  ...
                  helperText={
                    !companyForm.phone.trim() ? "Phone is required" : ""
                  }
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={
                    !locationForm.name.trim() ? "Location name is required" : ""
                  }
              ...
              <Grid item xs={12} md={6}>
                <TextField
                  ...
                  helperText={
                    !locationForm.city.trim() ? "City is required" : ""
                  }
                  sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2 } }}
                />
              </Grid>
              ...
              <Grid item xs={12} md={3}>
                <TextField
                  ...
                  helperText={
                    !locationForm.state.trim() ? "State is required" : ""
                  }
                  placeholder="e.g., CA, NY, TX"
                  sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2 } }}
                />
              ...
              <Grid item xs={12} md={3}>
                <TextField
                  ...
                  helperText={
                    !locationForm.postCode.trim() ? "Post code is required" : ""
                  }
                  placeholder="12345"
                  sx={{ "& .MuiOutlinedInput-root": { borderRadius: 2 } }}
                />
            ...
            <Grid container spacing={3}>
              ...
              {selectedCompany && selectedCompany.locations.length > 0 && (
                <Grid item xs={12}>
                    ...
                    {selectedCompany.locations.map((location) => (
                      <Box key={location.id} sx={{ mb: 1 }}>
                        <FormControlLabel
                          control={
                            <Checkbox
                              checked={userForm.assignedLocations.includes(
                                location.id
                              )}
                              onChange={() =>
                                handleLocationAssignmentToggle(location.id)
                              }
                              color="primary"
                            />
                          }
                  ...
                  >
                    Selected: {userForm.assignedLocations.length} location
                    {userForm.assignedLocations.length !== 1 ? "s" : ""}
                  </Typography>
                </Grid>
              )}
              ...
              <Grid item xs={12}>
                ...
                <Typography
                  ...
                  sx={{ mt: 1, display: "block" }}
                >
                  Selected: {userForm.permissions.length} permission
                  {userForm.permissions.length !== 1 ? "s" : ""}
                </Typography>
              </Grid>
            </Grid>
          )}

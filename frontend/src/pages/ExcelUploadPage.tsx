...
const ExcelUploadPage: React.FC = () => {
  ...
  useEffect(() => {
    if (selectedCity) {
      ...
      setFiles((prevFiles) =>
        prevFiles.map((file) =>
          file.status === "pending" ? { ...file, location: selectedCity } : file
        )
      );
    }
  }, [selectedCity]);
  ...
  const handleDashboardChange = (value: string) => {
    ...
    setFiles((prevFiles) =>
      prevFiles.map((file) =>
        file.status === "pending" ? { ...file, dashboard: value } : file
      )
    );
  };
  ...
  return (
    <Box sx={{ py: 4 }}>
      ...
      <Typography variant="subtitle1" color="text.secondary" paragraph>
        ...
        location. All files will be processed for the selected dashboard.
      </Typography>
            ...
            <CardContent>
              ...
              <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
                ...
                <FormControl sx={{ minWidth: 200 }}>
                  ...
                  <FormHelperText>
                    Select dashboard for all files
                  </FormHelperText>
                </FormControl>
              </Box>
